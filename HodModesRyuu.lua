...
local HodModesRyuu = {}
HodModesRyuu.__index = HodModesRyuu

local BLUE = Color3.fromRGB(20, 60, 140)
local BLUE_DIM = Color3.fromRGB(10, 30, 80)
local DARK = Color3.fromRGB(14, 10, 10)
local DARK2 = Color3.fromRGB(20, 15, 15)
local WHITE = Color3.fromRGB(255, 255, 255)
local GRAY = Color3.fromRGB(160, 160, 160)
local BG_IMAGE = "rbxassetid://93443025382768"
local LOGO_DECAL = "rbxassetid://88584554668512"

function HodModesRyuu:CreateWindow(config)
	config = config or {}
	local title = config.Title or "HodModesRyuu"
	...
	function Window:AddTab(tabConfig)
		...
		TabBtn.BackgroundColor3 = Color3.fromRGB(10, 20, 50)
		...
		TabActiveLine.BackgroundColor3 = BLUE
		...
		ScrollContainer.ScrollBarImageColor3 = BLUE
		...
		local function activateTab()
			...
			TweenService:Create(TabIconImg, TweenInfo.new(0.2), {ImageColor3 = BLUE}):Play()
		...
		function Tab:AddToggle(togConfig)
			...
			toggleTrack.BackgroundColor3 = Color3.fromRGB(10, 20, 55)
			...
			local function updateVisual(s)
				if s then
					TweenService:Create(toggleTrack, TweenInfo.new(0.2), {BackgroundColor3 = BLUE_DIM}):Play()
					TweenService:Create(knob, TweenInfo.new(0.2), {Position = UDim2.new(0, 21, 0.5, -9), BackgroundColor3 = BLUE}):Play()
				else
					TweenService:Create(toggleTrack, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(10, 20, 55)}):Play()
		...
		function Tab:AddSlider(sliderConfig)
			...
			sliderBox.BackgroundColor3 = Color3.fromRGB(10, 20, 50)
		...
		function Tab:AddDropdown(dropConfig)
			...
			dropList.BackgroundColor3 = Color3.fromRGB(7, 15, 40)
			...
			for idx, opt in ipairs(options) do
				...
				optBtn.BackgroundColor3 = Color3.fromRGB(10, 20, 55)
				optBtn.BackgroundTransparency = 0.4
				optBtn.Text = opt
				optBtn.TextColor3 = BLUE
				...
				optBtn.MouseLeave:Connect(function()
					TweenService:Create(optBtn, TweenInfo.new(0.1), {BackgroundTransparency = 0.4, TextColor3 = BLUE}):Play()
				end)
	...
	local function runNotifQueue()
		...
		while #notifQueue > 0 do
			...
			barBg.BackgroundColor3 = Color3.fromRGB(10, 20, 55)
