...
local ACCENT_DIM = Color3.fromRGB(147, 51, 234)
...
function RonemeUi:CreateWindow(config)
	...
	table.insert(allGradients, mainGrad)
	...
	function Window:AddTab(tabConfig)
		...
		local function makeRow(h)
			...
			table.insert(allGradients, rowStroke)
			return row
		end
		...
		function Tab:AddToggle(togConfig)
			...
			table.insert(allGradients, trackStroke)
		...
		function Tab:AddInput(inputConfig)
			...
			table.insert(allGradients, inputStroke)
		...
		function Tab:AddSlider(sliderConfig)
			...
			table.insert(allGradients, sliderStroke)
		...
		function Tab:AddDropdown(dropConfig)
			...
			table.insert(allGradients, dropStroke)
			...
			dropListStroke.Color = ACCENT
			dropListStroke.Thickness = 1.5
			dropListStroke.Transparency = 0.4
			table.insert(allGradients, dropListStroke)
	...
	task.spawn(function()
		while true do
			for i = 1, #allGradients do
				local grad = allGradients[i]
