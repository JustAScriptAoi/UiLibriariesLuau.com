...
local VisionLibrary = {}
VisionLibrary.__index = VisionLibrary

local BLUE = Color3.fromRGB(140, 80, 20)
local BLUE_DIM = Color3.fromRGB(80, 40, 10)
local DARK = Color3.fromRGB(14, 10, 10)
local DARK2 = Color3.fromRGB(20, 15, 15)
local WHITE = Color3.fromRGB(255, 255, 255)
local GRAY = Color3.fromRGB(160, 160, 160)
local BG_IMAGE = "rbxassetid://87620709201675"
local LOGO_DECAL = "rbxassetid://88584554668512"

function VisionLibrary:CreateWindow(config)
	config = config or {}
	local title = config.Title or "VisionLibrary"
	...
	function Window:AddTab(tabConfig)
		...
		TabBtn.BackgroundColor3 = Color3.fromRGB(50, 20, 10)
		...
		function Tab:AddToggle(togConfig)
			...
			toggleTrack.BackgroundColor3 = Color3.fromRGB(55, 20, 10)
			...
			local function updateVisual(s)
				if s then
					...
					TweenService:Create(toggleTrack, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(55, 20, 10)}):Play()
		...
		function Tab:AddSlider(sliderConfig)
			...
			sliderBox.BackgroundColor3 = Color3.fromRGB(50, 20, 10)
		...
		function Tab:AddDropdown(dropConfig)
			...
			dropList.BackgroundColor3 = Color3.fromRGB(40, 15, 7)
			...
			for idx, opt in ipairs(options) do
				...
				optBtn.BackgroundColor3 = Color3.fromRGB(55, 20, 10)
	...
	local function runNotifQueue()
		...
		while #notifQueue > 0 do
			...
			barBg.BackgroundColor3 = Color3.fromRGB(55, 20, 10)
